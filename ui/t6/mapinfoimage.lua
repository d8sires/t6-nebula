...
CoD.MapInfoImage.MapImageBottom = 125
CoD.MapInfoImage.MapImageLeft = -460
...
CoD.MapInfoImage.new = function (f1_arg0)
	...
	local f1_local1 = CoD.MapInfoImage.MapImageLeft + 460
	local f1_local2 = CoD.MapInfoImage.MapImageBottom + 40
	Widget.mapImage = LUI.UIImage.new({
		leftAnchor = true,
		rightAnchor = false,
		left = f1_local1,
		right = f1_local1 + CoD.MapInfoImage.MapImageWidth + 100,
		topAnchor = true,
		bottomAnchor = false,
		top = f1_local2 - CoD.MapInfoImage.MapImageHeight - 50,
		bottom = f1_local2,
		alpha = 0
	})
	...
	f1_local4:setLeftRight(true, false, f1_local1, f1_local1 + CoD.MapInfoImage.MapImageWidth + 100)
	f1_local4:setTopBottom(true, false, CoD.MPZM(f1_local2, f1_local2 - CoD.MapInfoImage.MapImageHeight), f1_local2 + f1_local3)
	...
	local new_alignment = CoD.MapInfoImage.MapImageWidth - 290
	Widget.gameTypeText = LUI.UIText.new({
		leftAnchor = true,
		rightAnchor = false,
		left = f1_local1 + new_alignment,
	...
	local f1_local8 = {}
	f1_local8 = GetTextDimensions(f1_local7, CoD.fonts.Default, Widget.loadingTextSize)
	local f1_local9 = type(f1_local8) == "table" and f1_local8[3] or 0
