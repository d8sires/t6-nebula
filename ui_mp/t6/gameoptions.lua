...
CoD.GameOptions.Button_Ladder_AddChoices = function (f12_arg0, f12_arg1, f12_arg2, f12_arg3)
	local f12_local0 = {
		"Normal Weapons",
		"Custom Weapons",
		"Random Weapons"
	...
	for f12_local4 = 1, f12_local3, 1 do
        local choiceValue = f12_local1[f12_local4] 
        f12_arg0:addChoice(f12_arg2, Engine.Localize(f12_local0[f12_local4]), choiceValue, {
            otherButton = f12_arg1
        }, function ()
            Engine.SetDvar("weapon_ladder", choiceValue)
        end)
    end
...
CoD.GameOptions.Button_Rotation_AddChoices = function (f12_arg0, f12_arg1, f12_arg2, f12_arg3)
	local f12_local0 = {
		"Off",
		"CSDVH",
		"Best Maps",
    ...
    if f12_local3 >= 1 then --off
        local choiceValue = f12_local1[1]
        f12_arg0:addChoice(f12_arg2, Engine.Localize(f12_local0[1]), choiceValue, {
            otherButton = f12_arg1
        }, function ()
            Engine.SetDvar("map_rotation", choiceValue)
			Engine.SetDvar("sv_maprotation", "")
        end)
    end

    if f12_local3 >= 2 then
        local choiceValue = f12_local1[2]
        f12_arg0:addChoice(f12_arg2, Engine.Localize(f12_local0[2]), choiceValue, {
            otherButton = f12_arg1
        }, function (clientInstance)
            Engine.SetDvar("map_rotation", choiceValue)
			Engine.SetDvar("sv_maprotation", "")
			Engine.Exec(clientInstance.controller, "ui_mapname mp_carrier")
        end)
    end

    if f12_local3 >= 3 then
        local choiceValue = f12_local1[3]
        f12_arg0:addChoice(f12_arg2, Engine.Localize(f12_local0[3]), choiceValue, {
            otherButton = f12_arg1
        }, function (clientInstance)
            Engine.SetDvar("map_rotation", choiceValue)
			Engine.SetDvar("sv_maprotation", "")
    ...
    if f12_local3 >= 4 then
        local choiceValue = f12_local1[4]
        f12_arg0:addChoice(f12_arg2, Engine.Localize(f12_local0[4]), choiceValue, {
            otherButton = f12_arg1
        }, function (clientInstance)
            Engine.SetDvar("map_rotation", choiceValue)
			Engine.SetDvar("sv_maprotation", "")
			Engine.Exec(clientInstance.controller, "ui_mapname mp_drone")
        end)
    end
...
CoD.GameOptions.Button_Rotation_AddChoices = function (f12_arg0, f12_arg1, f12_arg2, f12_arg3)
    ...
    if f12_local3 >= 3 then
        ...
        f12_arg0:addChoice(f12_arg2, Engine.Localize(f12_local0[3]), choiceValue, {
            ...
            Engine.SetDvar("time_limit", choiceValue)
        end)
    end
...
LUI.createMenu.EditNSOptions = function (f23_arg0)
	local f23_local0 = CoD.GameOptionsMenu.New(f23_arg0, "EditNSOptions")
	f23_local0:addTitle(Engine.Localize("PROJECT NEBULA SETTINGS"))
	local f23_local1 = UIExpression.DvarString(nil, "ui_gameType")
	if f23_local1 == "gun" then
		f23_local0.ggLadderButton = f23_local0.buttonList:addDvarLeftRightSelector(f23_arg0, Engine.Localize("GUN GAME LADDER:"), "weapon_ladder", Engine.Localize("Choose which Project Nebula gun game ladder you would like to use. Ported weapons will be given at last as normal. \n \nNormal Weapons: No Custom Weapons \n \nCustom Weapons: Ported weapons only. \n \nRandom Weapons: Ladder is random."))
		CoD.GameOptions.Button_Ladder_AddChoices(f23_local0.ggLadderButton, f23_arg0, true)
	end

	f23_local0.mapRotation = f23_local0.buttonList:addDvarLeftRightSelector(f23_arg0, Engine.Localize("MAP ROTATION:"), "map_rotation", Engine.Localize("CSDVH: Carrier, Studio, Detour, Vertigo, & Hydro. \n \nBest Maps: Carrier, Studio, Detour, Vertigo, Turbine, Yemen, Nuketown, Raid, Standoff, Downhill, & Express. \n \nVariety Maps: Drone, Slums, Mirage, Encore, Uplink, Dig, & Pod."))
	CoD.GameOptions.Button_Rotation_AddChoices(f23_local0.mapRotation, f23_arg0, true)
