...
CoD.Class.preset3ButtonPressed = function (IngameMenuWidget, ClientInstance)
    Engine.Exec(ClientInstance.controller, "map_restart")
end

CoD.Class.preset4ButtonPressed = function (IngameMenuWidget, ClientInstance)
    Engine.Exec(ClientInstance.controller, "fast_restart")
end

CoD.Class.preset5ButtonPressed = function (IngameMenuWidget, ClientInstance)
    Engine.Exec(ClientInstance.controller, "disconnect")
end

CoD.Class.preset6ButtonPressed = function (IngameMenuWidget, ClientInstance)
	IngameMenuWidget:saveState()
	IngameMenuWidget:openMenu("mapMenu", ClientInstance.controller)
	IngameMenuWidget:close()
end
...
CoD.Class.Button_CAC = function (f2_arg0, f2_arg1)
...
CoD.Class.Button_Action = function (f16_arg0, f16_arg1)
...
CoD.Class.PrepareClassButtonList = function (LocalClientIndex, IngameMenuWidget)
	...
	CoD.Class.AddButton(IngameMenuWidget, Engine.Localize("CHANGE MAP MENU"), "preset6")
	...
	CoD.Class.AddButton(IngameMenuWidget, Engine.Localize(" "))	
	CoD.Class.AddButton(IngameMenuWidget, Engine.Localize("DISCONNECT"), "preset5")	
	CoD.Class.AddButton(IngameMenuWidget, Engine.Localize("MAP RESTART"), "preset3")
	CoD.Class.AddButton(IngameMenuWidget, Engine.Localize("FAST RESTART"), "preset4")
	end
...
LUI.createMenu.class = function (LocalClientIndex)
	...
	IngameMenuWidget:registerEventHandler("preset3", CoD.Class.preset3ButtonPressed)
	IngameMenuWidget:registerEventHandler("preset4", CoD.Class.preset4ButtonPressed)
	IngameMenuWidget:registerEventHandler("preset5", CoD.Class.preset5ButtonPressed)
	IngameMenuWidget:registerEventHandler("preset6", CoD.Class.preset6ButtonPressed)
