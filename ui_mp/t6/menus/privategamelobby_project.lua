...
Engine.SetDvar("sv_hostname", "Project Nebula")
Engine.SetDvar("sv_motd", "You are playing Project Nebula.")
Engine.SetDvar("sv_cheats", "1")
Engine.SetDvar("sv_maxclients", "18")
Engine.SetDvar("sv_patch_dsr50", "1")
Engine.SetDvar("g_fixBulletDamageDupe", "0")
Engine.SetDvar("weapon_ladder", "0")
...
CoD.PrivateGameLobby.PopulateButtons_Project_Multiplayer = function (PrivateGameLobbyButtonPane, IsHost)
	...
	--	PrivateGameLobbyButtonPane.body.buttonSpacer = PrivateGameLobbyButtonPane.body.buttonList:addSpacer(CoD.CoD9Button.Height / 2)
	--end

	local gameModeOptions = {
		name = "GUN GAME LADDER:",
		settingName = "game_mode_selector",
		labels = {
			"Text 1",
			"Text 2",
			"Text 3"
	...
	PrivateGameLobbyButtonPane.body.nebulaButton = PrivateGameLobbyButtonPane.body.buttonList:addButton(Engine.Localize("SETUP PROJECT NEBULA"))
	PrivateGameLobbyButtonPane.body.nebulaButton.hintText = Engine.Localize("Customize Project Nebula before you start the game.")
	PrivateGameLobbyButtonPane.body.nebulaButton:setActionEventName("open_ns_menu")

	local notice = LUI.UIText.new()
	notice:setLeftRight(true, false, 465, 200) 
	notice:setTopBottom(true, false, 105, 123) 
	notice:setText(Engine.Localize("[^5v2.0.3^7] Want to play ^5Project Nebula^7 on other games? Join the Discord! ^1<3^7"))
	notice:setFont(CoD.fonts.Small) 
	notice:setRGB(1, 1, 1)
	notice:setAlpha(0.3)
	PrivateGameLobbyButtonPane:addElement(notice)
...
CoD.PrivateGameLobby.OpenNSMenu = function (PrivateGameLobbyWidget, ClientInstance)
	Engine.PartyHostSetUIState(CoD.PARTYHOST_STATE_EDITING_GAME_OPTIONS)
	PrivateGameLobbyWidget:openPopup("EditNSOptions", ClientInstance.controller)
	Engine.PlaySound("cac_screen_fade")
end
...
CoD.PrivateGameLobby.RegisterEventHandler_Project = function (PrivateGameLobbyWidget)
	if CoD.isZombie == true then
		...
		PrivateGameLobbyWidget:registerEventHandler("start_game", CoD.PrivateGameLobby.ButtonStartGame)
		PrivateGameLobbyWidget:registerEventHandler("open_setup_game_flyout", CoD.PrivateGameLobby.OpenSetupGameFlyout)
		PrivateGameLobbyWidget:registerEventHandler("open_bots_menu", CoD.PrivateGameLobby.OpenBotsMenu)
		PrivateGameLobbyWidget:registerEventHandler("open_ns_menu", CoD.PrivateGameLobby.OpenNSMenu)
		PrivateGameLobbyWidget:registerEventHandler("open_change_map", CoD.PrivateGameLobby.OpenChangeMap)
		PrivateGameLobbyWidget:registerEventHandler("open_change_game_mode", CoD.PrivateGameLobby.OpenChangeGameMode)
		PrivateGameLobbyWidget:registerEventHandler("open_editGameOptions_menu", CoD.PrivateGameLobby.OpenEditGameOptionsMenu)
		PrivateGameLobbyWidget:registerEventHandler("open_viewGameOptions_menu", CoD.PrivateGameLobby.OpenViewGameOptionsMenu)
